...
public class StringUtils {
	...
	public static String timestamp2String(Timestamp timestamp) {
		String dataTime = MessageFormat.format("{0,date,yyyy年MM月dd日HH时mm分}", new Object[] { timestamp });
		return dataTime;
	}

	/**
	 * 
	 * TODO date转换为Timestamp
	 * 
	 * @param date
	 * @return
	 * @throws Exception
	...
	public static String date2String(Date date) {
		String dataTime = MessageFormat.format("{0,date,yyyy年MM月dd日}", new Object[] { date });
		return dataTime;
	}
